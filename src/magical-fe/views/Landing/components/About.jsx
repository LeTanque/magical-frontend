...
const About = () => (
    <section className="container mx-auto px-6 p-10">
        ...
        <div className="flex items-center flex-wrap mb-16">
            ...
            <div className="w-full md:w-1/2 flex justify-center" style={{ fontSize: "2rem" }}>
                <Keyrune set="ugl"    foil size="6x" className="" rarity="uncommon" />
            </div>
        </div>
        <div className="flex items-center flex-wrap-reverse md:flex-wrap mb-16">
            <div className="w-full md:w-1/2 flex justify-center" style={{ fontSize: "2rem" }}>
                <Keyrune set="iko"    foil size="6x" className="" rarity="rare" />
            </div>
            <div className="w-full md:w-1/2">
